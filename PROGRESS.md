...
| Phase 5 | Frontend — Auth pages (Login / Register) | ⬜ Not started |
| Phase 6 | Frontend — Investments page (Table + CRUD) | ⬜ Not started |
| Phase 7 | Frontend — Portfolio summary + Pagination | ⬜ Not started |
| Phase 8 | Docker + Deployment | ⬜ Not started |
| Phase 9 | README finalization + Smoke test | ⬜ Not started |
...
- **2026-07-20:** Planning docs complete. Build begins Phase 1 next.
