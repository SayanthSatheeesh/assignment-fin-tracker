      ...
      <div className="w-full max-w-[420px] bg-card rounded-2xl p-8 sm:p-10 border border-border/50 shadow-xl shadow-black/5">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          <div className="space-y-2">
            <label className="text-foreground text-sm font-semibold block">Full name</label>
            <input
              type="text" 
              value={name} 
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground mt-1.5 font-medium">Must be at least 6 characters long.</p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-border/50 text-center">
          ...
          <Link href="/login" className="text-primary text-sm font-semibold hover:underline decoration-primary/30 underline-offset-4 transition-all">
            Sign In
          </Link>
        </div>
      </div>
